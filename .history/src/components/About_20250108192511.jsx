    ...
    return (
        <div>
            ...
            <section className="p-8 bg-[#fffaf0]">
                <h2 className="text-3xl font-bold te
                xt-[#8b8000] text-center mb-8">Our Services</h2>
            ...
            <div className="bg-gray-100 py-8">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-lg font-bold">163 Enmore Road, Enmore NSW 2042</p>
                    ...
                    <p className="text-lg"><a href="mailto:compactchefsevents@gmail.com" target="_blank"
                        rel="noopener noreferrer" className='py-1 hover:text-gold  font-normal'>compactchefsevents@gmail.com</a></p>
                </div>
            </div>
        </div >
    );
