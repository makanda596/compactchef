...
function About() {
    ...
    const [zoom, setZoom] = useState(1); // Zoom level for the image
    const [currentIndex, setCurrentIndex] = useState(null); // Index of the selected image
    ...
    // Open the selected image in modal
    ...
    const closeModal = () => {
        ...
        setZoom(1); // Reset zoom on closing modal
    ...
    return (
        <div>
            ...
            <div className="relative bg-gold h-auto text-white my-10 p-6 md:p-14 ml-5 md:ml-32 flex flex-col md:flex-row gap-8 w-[90%] md:w-3/4">
                ...
                <div className="md:w-3/4 mt-4 md:mt-[-100px]">
                    <video
                        ...
                        loop
                    >
                        <source src="https://res.cloudinary.com/db5pgr14l/video/upload/v1737108092/VID-20250105-WA0029_xdwzl5.mp4" type="video/mp4" />
                    </video>
                </div>
            ...
            <section className="p-8">
                ...
                {/* Display selected image in a modal */}
                {selectedImage && (
                    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
                        <div className="relative">
                            {/* Close button */}
                            <button
                                className="absolute top-4 right-16 text-white bg-red-600 hover:bg-red-700 p-2 rounded-full"
                                onClick={closeModal}
                            >
                                ✕
                            </button>
                            ...
                            {/* Display the selected image with zoom */}
                            <img
                                src={selectedImage}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                    {images.map((image, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true, amount: 0.5 }}
                            transition={{ delay: index * 0.1, duration: 0.5 }}
                            onClick={() => handleImageClick(image, index)} // Open modal on image click
                        >
                            <img
                                src={image}
                ...
                <button className="mt-6 px-6 py-2 bg-[#8b8000] text-white rounded-lg">VISIT GALLERY</button>
            </section>
