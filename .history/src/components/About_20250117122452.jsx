        ...
        <div>
            ...
            <div className="relative bg-gold h-auto text-white my-10 p-6 md:p-14 ml-5 md:ml-32 flex flex-col md:flex-row gap-8 w-[90%] md:w-3/4">
                ...
                <div className="md:w-1/2">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row sm:space-x-8 text-base md:text-xl font-semibold">
                ...
                <div className="md:w-3/4 mt-4 md:mt-[-100px]">
                    <iframe
                        className="w-full h-56 sm:h-72 md:h-96 ml-40 mx-auto rounded-lg shadow-lg"
                ...
                <img
                    ...
                    alt=""
                    className="absolute top-64 left-5 w-1/2 h-32 sm:h-48 md:h-64 object-cover rounded-lg shadow-lg"
                />
            </div>
