...
function About() {
    ...
    return (
        <div>
            ...
            <div className="bg-gray-100 py-8 attachment-fixed" style={{ backgroundImage: "url('https://res.cloudinary.com/db5pgr14l/image/upload/v1736264671/compactChef/rzduwk5ix2dmgjv1m0at.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
