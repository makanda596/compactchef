...
function About() {
    ...
    return (
        <div>
            ...
            <div className="bg-gold text-white p-10 flex w-3/4 flex-col md:flex-row gap-8 items-center">
                {/* Text Section */}
                ...
                <div className="md:w-1/2 mt-[-100px] ml-60 relative">
                    <iframe
                        className="w-full h-64 rounded-lg shadow-lg"
                        src="https://www.youtube.com/embed/cCPKVqu8trI?si=2CVmcjzg3bEehn9t" title="YouTube video player"  // Replace with your video link
