    ...
    return (
        <div>
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('https://res.cloudinary.com/db5pgr14l/image/upload/v1737449664/photo-1512034400317-de97d7d6c3ed_b8kjci.avif')",
            ...
            >
                <div className="max-w-4xl mx-auto px-4 text-white text-center">
                    ...
                    <p className="text-lg">
                        <a href="tel:+254791317298" target="_blank" rel="noopener noreferrer" className="py-1 hover:text-gold">
                            +254 791 317 298
                        </a>
                    </p>
                    <p className="text-lg">
                        <a href="mailto:compactchefsevents@gmail.com" target="_blank" rel="noopener noreferrer" className="py-1 hover:text-gold font-normal">
