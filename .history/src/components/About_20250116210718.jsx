...
function About() {
    ...
    return (
        <div>
            ...
            <div className="bg-gray-100 py-8" style={{ backgroundImage: "https://res.cloudinary.com/db5pgr14l/image/upload/v1736264342/compactChef/a8jba9dz0qq0wnfzacjg.jpg", backgroundSize: 'cover', backgroundPosition: 'center' }}>
