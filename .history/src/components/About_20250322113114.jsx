...
function About() {
    ...
    const services = [
        ...
        {
            name: "MC Services",
            description: " Our experienced Master of Ceremonies ensures smooth event flow, keeps guests entertained, and maintains an energetic atmosphere from start to finish..",
            image: "https://res.cloudinary.com/db5pgr14l/image/upload/v1742620833/IMG-20250106-WA0053_u52boc.jpg", // Replace with actual image URL
        },
        {
            name: "Tent Services",
            description: "Our well-designed tents provide the perfect shelter while enhancing the ambiance of your occasion. We offer a variety of tent sizes and styles, complete with decorations, lighting, and seating arrangements to match your theme.",
        ...
        <div>
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                        {[
                            ...
                            "https://res.cloudinary.com/db5pgr14l/image/upload/v1742618592/IMG-20250301-WA0046_cr27zt.jpg",
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                        {[
                            "https://res.cloudinary.com/db5pgr14l/image/upload/v1742620557/IMG-20250301-WA0043_d7i3r2.jpg",
                            "https://res.cloudinary.com/db5pgr14l/image/upload/v1742632159/IMG-20250322-WA0005_csbqqg.jpg",
            ...
            >
                <div className="max-w-4xl mx-auto px-4 text-white font-bold text-center">
                    <h2 className="text-xl font-semibold mb-4 opacity-100">CONTACT US FOR A QUOTE</h2>
