                    ...
                    <div>
                        ...
                        <ul className="text-md text-gray-300 space-y-4 flex-row">
                            ...
                            <li>  <a href="mailto:murimiisaac8@gmail.com" target="_blank"
                                rel="noopener noreferrer" className='py-1 hover:text-gold'>Email :murimiisaac8@gmail.com</a> </li> <br />
                            <a href="tel:+254796962375" target="_blank"
                                rel="noopener noreferrer" className='py-1 hover:text-gold'>Phone: 0796962375</a>
                        </ul>
