...
function About() {
    const menuItems = [
        {
            ...
            image: "https://res.cloudinary.com/db5pgr14l/image/upload/v1736313944/ugenya_syoeky.jpg", // Replace with actual image URL
    ...
    return (
        <div>
            ...
            <div className="bg-white p-8"> <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center"> <div className="md:w-1/2 md:pr-8"> <h1 className="text-4xl font-cursive mb-4">Menus</h1> <p className="text-lg mb-6"> Come see the items featured from our scratch made kitchen. </p> <div className="flex space-x-4"> <button className="bg-gray-900 text-white px-4 py-2 rounded"> ATLANTA </button> <button className="bg-gray-900 text-white px-4 py-2 rounded"> CARY </button> </div> </div> <div className="md:w-1/2 mt-8 md:mt-0"> <img src="your_image_source.jpg" alt="Various dishes" className="w-full rounded" />
                <section className="p-8 bg-[#fffaf0]">
