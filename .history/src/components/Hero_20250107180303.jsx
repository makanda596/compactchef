    ...
    return (
        ...
        <div className="grid md:grid-cols-2 gap-4 my-2 px-2 pt-20">
            <div className="relative flex flex-col h-screen">
                <img src="https://res.cloudinary.com/db5pgr14l/image/upload/v1736261948/compactChef/jppnffdu5letvjtqxvnn.jpg" alt="Hero" className="object-cover w-full h-full" />
