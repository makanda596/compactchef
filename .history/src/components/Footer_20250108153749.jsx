            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="text-sm text-gray-300 space-y-4 flex-row">
                            <li>Kisumu ,Kenya</li>
                            <li>  <a href="mailto:murimiisaac8@gmail.com" target="_blank"
                                rel="noopener noreferrer">Email :murimiisaac8@gmail.com</a> </li> <br />
                            <a href="tel:+254796962375" target="_blank"
                                rel="noopener noreferrer" className='py-1'>Phone: 0796962375</a>
                        </ul>
