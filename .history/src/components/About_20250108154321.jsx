            ...
            <div className="bg-gray-100 py-8">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-lg"><    <a href="tel:+254791317298" target="_blank"
                        rel="noopener noreferrer" className='py-1 hover:text-gold'>Phone: +254 791 317 298</a>/p>
                        <p className="text-lg"><a href="mailto:compactchefsevents@gmail.com" target="_blank"
                            rel="noopener noreferrer" className='py-1 hover:text-gold'>Email :compactchefsevents@gmail.com</a></p>
                </div>
            </div>
        </div>
    );
