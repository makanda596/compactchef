    ...
    return (
        <div>
            ...
            <div className="relative bg-gold h-96 text-white my-10 p-14 ml-32 flex flex-col md:flex-row gap-8 w-3/4">
                ...
                <img src="https://res.cloudinary.com/db5pgr14l/image/upload/v1736497255/private_aj5o24.jpg" alt="" className='absolute top-64 left-5 w-1/2 h-64 object-cover mb-10' />
