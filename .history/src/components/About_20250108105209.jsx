        ...
        <div>
            ...
            <div className="bg-white p-8">
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2 mt-8 md:mt-0">
                        <img src="https://res.cloudinary.com/db5pgr14l/image/upload/v1736313944/ugenya_syoeky.jpg" alt="Various dishes" className="w-full rounded" />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-100 py-8">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-lg">(02) 7205 2922</p>
                    <p className="text-lg">info@compactchef.com.au</p>
                </div>
            </div>
        </div>
    );
