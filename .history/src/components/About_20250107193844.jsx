    ...
    return (
        <div>
            ...
            <section className="p-8 bg-[#fffaf0]">
                ...
                <p className='justify-items-center items-center'></p>The menu items displayed below are a selection of our preferred and randomly curated dishes. However, we are delighted to customize the menu to suit your specific tastes and event needs. Let us know your preferences, and we’ll create a culinary experience uniquely tailored for you
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {menuItems.map((item, index) => (
                        <div key={index} className="relative group overflow-hidden rounded-lg shadow-lg">
                            ...
                            <div className="absolute top-4 left-4 bg-[#8b8000] text-white py-1 px-3 rounded-lg text-sm font-semibold">
                                {item.title}
                            </div>
                        </div>
                    ))}
