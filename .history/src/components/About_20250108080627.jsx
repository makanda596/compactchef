                ...
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    {menuItems.map((item, index) => (
                        ...
                        >
                            ...
                            {/* Title */}
                            <h3 className="text-lg font-bold text-center text-gray-800 mt-4">
                                {item.title}
                            </h3>
                            ...
                            <div className="flex justify-between p-4">
                                <a
                                    ...
                                    download
                                    className="bg-[#8b8000] text-white py-2 px-4 rounded-lg text-sm hover:bg-[#a08d00] transition-colors duration-300"
                                >
                                    Download
                                </a>
                                <a
                                    href={item.viewLink} // View menu link
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="bg-gray-200 text-gray-800 py-2 px-4 rounded-lg text-sm hover:bg-gray-300 transition-colors duration-300"
                                >
                                    View Menu
                                </a>
                            </div>
