        ...
        <footer className="bg-[#1a1a1a] text-white py-10">
            <div className="max-w-7xl mx-auto px-6 sm:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    {/* Use grid-cols-1 for small screens to make "Explore" and "Get in Touch" in one column */}
                    <div className="md:grid md:grid-cols-1 space-y-4 md:space-y-0">
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="text-md text-gray-300 space-y-4">
                                <li>Kisumu, Kenya</li>
                                <li><a href="mailto:compactchefsevents@gmail.com" target="_blank"
                                    rel="noopener noreferrer" className='py-1 hover:text-gold'>Email :compactchefsevents@gmail.com</a> </li>
                            ...
                            <div className="pt-2 md:pt-6">
                                ...
                                <div className="flex space-x-6 justify-start">
                                    <a
                                        href="https://www.facebook.com/search/people?q=Compactchefs%20event%20"
                                        target="_blank"
