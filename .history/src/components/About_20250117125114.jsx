    ...
    return (
        <div>
            ...
            <div className="relative bg-gold h-auto text-white my-10 p-6 md:p-14 ml-5 md:ml-32 flex flex-col md:flex-row gap-8 w-[90%] md:w-3/4">
                ...
                <div className="md:w-3/4 mt-4 md:mt-[-100px]">
                    <video
                        ...
                        loop
                    >
                        <source src="../assets/VID-20250105-WA0035.mp4" type="video/mp4" />
                    </video>
                </div>
            ...
            <div className="bg-pink-50 p-10">
                ...
                <div className="flex gap-8 overflow-x-scroll scrollbar-hide snap-x snap-mandatory">
                    {/* Menu Card 1 */}
                    <div className="min-w-[300px] flex-shrink-0 snap-center bg-white rounded-lg shadow-lg p-6 text-center">
                        <img
                            src="path-to-menu1.jpg" // Replace with the actual image path
                            alt="Appetizers"
                            className="w-full h-40 object-cover rounded-t-lg"
                        />
                        <h3 className="text-xl font-semibold text-pink-800 mt-4">Appetizers</h3>
                        <p className="text-pink-700 mt-2">Start your event with our gourmet appetizers, crafted to perfection.</p>
                    </div>

                    {/* Menu Card 2 */}
                    <div className="min-w-[300px] flex-shrink-0 snap-center bg-white rounded-lg shadow-lg p-6 text-center">
                        <img
                            src="path-to-menu2.jpg" // Replace with the actual image path
                            alt="Main Courses"
                            className="w-full h-40 object-cover rounded-t-lg"
                        />
                        <h3 className="text-xl font-semibold text-pink-800 mt-4">Main Courses</h3>
                        <p className="text-pink-700 mt-2">Delight in our savory main courses, crafted from fresh ingredients.</p>
                    </div>

                    {/* Menu Card 3 */}
                    <div className="min-w-[300px] flex-shrink-0 snap-center bg-white rounded-lg shadow-lg p-6 text-center">
                        <img
                            src="path-to-menu3.jpg" // Replace with the actual image path
                            alt="Desserts"
                            className="w-full h-40 object-cover rounded-t-lg"
                        />
                        <h3 className="text-xl font-semibold text-pink-800 mt-4">Desserts</h3>
                        <p className="text-pink-700 mt-2">Indulge in our decadent desserts to end your meal on a sweet note.</p>
                    </div>

                    {/* Menu Card 4 */}
                    <div className="min-w-[300px] flex-shrink-0 snap-center bg-white rounded-lg shadow-lg p-6 text-center">
                        <img
                            src="path-to-menu4.jpg" // Replace with the actual image path
                            alt="Beverages"
                            className="w-full h-40 object-cover rounded-t-lg"
                        />
                        <h3 className="text-xl font-semibold text-pink-800 mt-4">Beverages</h3>
                        <p className="text-pink-700 mt-2">Refresh with our selection of drinks, perfect for any occasion.</p>
                    </div>
                </div>
            </div>
