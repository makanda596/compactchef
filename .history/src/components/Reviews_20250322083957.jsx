        ...
        <div className="bg-white py-8">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <form onSubmit={handleSubmit} className="mb-6 p-4 bg-gray-100 rounded-lg shadow">
                    ...
                    <input type="text" placeholder="Your Name" value={name} onChange={(e) => setName(e.target.value)} required className="w-full p-2 mb-2 border rounded" />
                    <select value={rating} onChange={(e) => setRating(e.target.value)} className="w-full p-2 mb-2 border rounded">
                        <option>★★★★★</option>
                        <option>★★★★</option>
                        <option>★★★</option>
                        <option>★★</option>
                    ...
                    <textarea placeholder="Your Review" value={review} onChange={(e) => setReview(e.target.value)} required className="w-full p-2 mb-2 border rounded"></textarea>
                    <button type="submit" className="bg-[#8b8000] text-white px-4 py-2 rounded hover:bg-yellow-700 transition">Submit Review</button>
                </form>
