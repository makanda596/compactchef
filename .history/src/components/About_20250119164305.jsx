                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
                        {[
                            ...
                            "https://res.cloudinary.com/db5pgr14l/image/upload/v1737293956/IMG-20250119-WA0056_vbikna.jpg",
                        ].map((image, index) => (
                            <motion.div
                                key={index}
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            "https://res.cloudinary.com/db5pgr14l/image/upload/v1737293338/WhatsApp_Image_2025-01-19_at_16.24.37_ca4fb2a5_o4sb7e.jpg",
                        ].map((image, index) => (
                            <motion.div
                                key={index}
                                className="overflow-hidden rounded-lg shadow-lg cursor-pointer"
