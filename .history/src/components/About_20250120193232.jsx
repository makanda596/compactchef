    ...
    return (
        <div>
            ...
            <section className="p-2 mt-4 md:p-8">
                ...
                <div className="flex items-center justify-between mb-8 px-20">
                    <h2 className="text-2xl font-bold text-[#8b8000]">Our Gallery</h2>
                    <button className="dotted  px-4 py-2 text-md font-serif  text-blue-600 hover:text-red-600 transition-all">
