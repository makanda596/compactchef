...
function About() {
    ...
    const services = [
        ...
        },
        {
            ...
            image: "https://res.cloudinary.com/db5pgr14l/image/upload/v1737291091/IMG-20250105-WA0280_stddpe.jpg",
        },
        {
            name: "Birthday",
    ...
    const images = [
        ...
        "https://res.cloudinary.com/db5pgr14l/image/upload/v1737291362/IMG-20250105-WA0298_xaqaqg.jpg"
    ];
    ...
    return (
        <div>
            ...
            <div className="bg-gray-100 py-8" style={{ backgroundImage: "url('https://res.cloudinary.com/db5pgr14l/image/upload/v1736264671/compactChef/rzduwk5ix2dmgjv1m0at.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <div className="max-w-4xl mx-auto px-4 text-black text-center">
                    ...
                    <button className="bg-[#8b8000] text-black px-6 py-3 mb-4 rounded hover:bg-[#a08d00] transition-colors duration-300">
