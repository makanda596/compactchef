    ...
    const menuItems = [
        {
            ...
            downloadLink: "https://res.cloudinary.com/db5pgr14l/raw/upload/v1736311737/grilled_chicken_menu.docx", // Replace with actual document link
        },
        {
            title: "Lunch Dish",
            image: "https://via.placeholder.com/300", // Replace with actual image URL
                    ...
                    {menuItems.map((item, index) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                ...
                                <a
                                    href={item.downloadLink} // Download link for each item
                                    download
                                    className="bg-[#8b8000] text-white py-1 px-4 rounded-lg text-sm hover:bg-[#a08d00] transition-colors duration-300"
                                >
                                    Download Menu
                                </a>
                            </div>
