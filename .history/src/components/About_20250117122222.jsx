...
function About() {
    ...
    return (
        <div>
            ...
            <div className="relative bg-gold text-white my-10 p-6 md:p-14 flex flex-col md:flex-row gap-8 w-full md:w-3/4 mx-auto">
                {/* Text Section */}
                <div className="md:w-1/2">
                    ...
                    <div className="mt-6 flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 text-lg font-semibold">
                        <div>
                            <p>2020-2025</p>
                ...
                <img
                    ...
                    alt="Event Thumbnail"
                    className="absolute bottom-5 left-5 w-40 h-32 md:w-64 md:h-48 rounded-lg object-cover shadow-lg"
                />
            </div>
