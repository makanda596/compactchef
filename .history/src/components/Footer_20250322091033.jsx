        ...
        <footer className="bg-[#1a1a1a] text-white py-10">
            <div className="max-w-7xl mx-auto px-6 sm:px-8">
                ...
                <div className="text-center space-y-2 text-md">
                    <h3 className="text-xl font-bold text-[#d4af37]">Subscribe to our Newsletter</h3>
                    <form onSubmit={handleSubscribe} className="flex flex-col md:flex-row justify-center items-center gap-4 mt-4">
                        <input
                            type="email"
