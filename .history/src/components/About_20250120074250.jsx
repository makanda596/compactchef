        ...
        <div>
            ...
            <section className="p-2 mt-4 md:p-8">
                ...
                <div className="flex items-center justify-between mb-8">
                    <h2 className="text-3xl font-bold text-[#8b8000]">Our Gallery</h2>
                    <button className="bg-gold px-4 py-2 rounded-md shadow-md text-black hover:bg-yellow-600 transition-all">
                        VISIT GALLERY
                    </button>
                </div>
