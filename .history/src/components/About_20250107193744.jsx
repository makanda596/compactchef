    ...
    return (
        <div>
            ...
            <section className="p-8 bg-[#fffaf0]">
                ...
                <p></p>The menu items displayed below are a selection of our preferred and randomly curated dishes. However, we are delighted to customize the menu to suit your specific tastes and event needs. Let us know your preferences, and we’ll create a culinary experience uniquely tailored for you
