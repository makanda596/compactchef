        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    <a
                        href="/contact"
                        className=" text-white py-2 px-6 rounded-lg text-lg hover:bg-[#a08d00] transition-colors duration-300"
                    >
                        Contact Us
                    </a>
                </motion.div>
            ...
            <div className="bg-green-600 text-white p-10 flex flex-col md:flex-row gap-8 items-center">
                {/* Text Section */}
                ...
                <div className="md:w-1/2">
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/xyz123" // Replace with your video link
