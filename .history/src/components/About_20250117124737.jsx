...
function About() {
    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row bg-pink-50 p-10 items-center justify-center gap-8">
                {/* Image Section */}
                <div className="md:w-1/2">
                    <img
                        src="path-to-your-image.jpg" // Replace with the path to your dish image
                        alt="Delicious Dish"
                ...
                <div className="md:w-1/2 text-center md:text-left">
                    <h2 className="text-3xl font-bold text-pink-900">
                        Made of <span className="italic">Exquisite Ingredients</span>
                    </h2>
                    <p className="text-lg mt-4 text-pink-700">
                        Explore our carefully curated menus at Compact Chef Events. From
                        gourmet appetizers to mouth-watering desserts, we bring the taste
                        of luxury to your table.
                    </p>
                    <button className="mt-6 px-6 py-2 bg-pink-600 text-white text-lg font-semibold rounded-lg shadow-lg hover:bg-pink-700">
                        View Our Menus
                    </button>
                </div>
            </div>
