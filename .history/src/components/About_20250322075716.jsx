    ...
    const services = [
        {
            ...
            description: "We We specialize in elegant and customized event decorations, creating the perfect ambiance for weddings, corporate functions, birthdays, and special celebrations",
