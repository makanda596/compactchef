...
function About() {
    ...
    const { inView } = useInView({
        ...
        threshold: 0.5, // 50% of the element must be visible before triggering
    });
            ...
            >
                ...
                <motion.div
                    ...
                    transition={{
                        duration: 1.2,
                        ease: "easeOut",
                        delay: 0.2, // Slight delay for right side content to animate after the image
                    }}
                >
            ...
            <div className="bg-white p-8">
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center">
                    ...
                    <div className="md:w-1/2 mt-8 md:mt-0">
                        <img src="your_image_source.jpg" alt="Various dishes" className="w-full rounded" />
                    </div>
                </div>
            </div>
