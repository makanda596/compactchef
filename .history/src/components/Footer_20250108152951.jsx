            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8">
                ...
                <div className="text-center">
                    <p className="text-sm text-gray-400">
                        &copy; {new Date().getFullYear()} Compact Chef Events and Caterers. Created by <a href="https://wa.me/+254742149060" target="_blank" rel="noopener noreferrer"> Makanda Worksoft</a>All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
