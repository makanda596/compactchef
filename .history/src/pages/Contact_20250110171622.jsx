...
const ContactPage = () => {
    return (
        <div className="min-h-screen py-6 m-4 w-auto sm:py-12 ">
            <div className="relative grid grid-col-2 py-3 sm:max-w-full sm:mx-auto">
                <div className="relative px-0 py-10 bg-white shadow-lg w-full sm:rounded-3xl sm:p-0">
                    <div className="flex flex-wrap w-full">
                        ...
                        <div className="w-96 sm:w-96 p-2 bg-gold text-white rounded-xl shadow-lg">
                            <div className="pb-6">
                        ...
                        <div className="w-auto ">
                            <div className="divide-y divide-gray-200 space-y-6">
                                ...
                                <div className="grid grid-cols-1 bg-red-600 sm:grid-cols-2 gap-4 pt-6">
                                    {/* Column 1 - Name and Email */}
                                    <div className="flex flex-col">
                                        <label className="leading-loose text-gray-800">Name</label>
                                        <input
                                            type="text"
                                            className="px-4 py-3 w-96 border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors md:w-96"
