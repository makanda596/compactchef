                    ...
                    <div className="relative px-0 py-10 bg-white shadow-lg w-full sm:rounded-3xl sm:p-0">
                        <div className="flex flex-wrap w-full">
                            <div className="w-full sm:w-96 p-6 bg-gold text-black rounded-xl shadow-lg">
                                <div className="pb-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="flex items-center">
                                            ...
                                            <a href="tel:+254791317298" target="_blank" rel="noopener noreferrer">+254 791 317 298</a>
                                        </p>
                                        <p className="flex items-center">
                                            <EmailIcon className="mr-3 text-2xl" />
                                            <a href="mailto:compactchefsevents@gmail.com" target="_blank" rel="noopener noreferrer">compactchefsevents@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                                ...
                                {/* image */}
                                <img src="https://res.cloudinary.com/db5pgr14l/image/upload/v1736265751/wedding_nfkcue.jpg" alt="" className="w-full h-60 object-cover rounded-xl pt-2" />
                            </div>
                                    ...
                                    <form onSubmit={onSubmit}>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                                            <div className="flex flex-col">
                                                ...
                                                <input type="text" name="name" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Your Name" />
                                            </div>
                                            <div className="flex flex-col">
                                                <label className="leading-loose text-gray-800">Email</label>
                                                <input type="email" name="email" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Your Email" />
                                            </div>

                                            <div className="flex flex-col">
                                                <label className="leading-loose text-gray-800">Phone Number</label>
                                                <input type="number" name="phone" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Your Phone Number" />
                                            </div>
                                            <div className="flex flex-col">
                                                <label className="leading-loose text-gray-800">Company/Organization Name (Optional)</label>
                                                <input type="text" name="company" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Your Company Name (Optional)" />
                                            </div>

                                            <div className="flex flex-col">
                                                <label className="leading-loose text-gray-800">Type of Service</label>
                                                <select name="service_type" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <input type="date" name="date" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" />
                                            </div>
                                            <div className="flex flex-col">
                                                <label className="leading-loose text-gray-800">Number of People</label>
                                                <input type="number" name="num_people" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Number of People" />
                                            </div>
                                            <div className="flex flex-col">
                                                <label className="leading-loose text-gray-800">Venue (If Already Decided)</label>
                                                <input type="text" name="venue" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Venue Name" />
                                            </div>
                                            <div className="flex flex-col sm:col-span-2">
                                                <label className="leading-loose text-gray-800">Additional Information</label>
                                                <textarea name="additional_info" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Any Additional Information"></textarea>
                                            </div>
                                        </div>

                                        <div className="pt-6 flex items-center space-x-4">
                                            <button type="submit" className="bg-blue-500 flex justify-center items-center w-96 text-white px-6 py-3 rounded-md shadow-md hover:bg-blue-600 transition-colors">
                                                Submit
                                            </button>
                                        </div>
                                    </form>
