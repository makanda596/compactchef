                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <p className="flex items-center">
                                            ...
                                            <a href="tel:+254791317298" target="_blank"
                                                rel="noopener noreferrer">+254 791 317 298</a>
                                        </p>
                                        <p className="flex items-center">
                                            <EmailIcon className="mr-3 text-2xl" />
                                            <a href="mailto:compactchefsevents@gmail.com" target="_blank"
                                                rel="noopener noreferrer" >compactchefsevents@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="w-full p-6 pt-2 md:w-2/3">
                                <div className="divide-y divide-gray-200 space-y-0">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2  gap-4 pt-2">
                                        <form onSubmit={onSubmit}>
                                            ...
                                            <div className="flex flex-col sm:col-span-2">
                                                <label className="leading-loose text-gray-800">Aditional Infomation</label>
                                                <textarea
                                                    className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors"
                                                    placeholder="Any Aditional Infomation"
                                                ></textarea>
                                            </div>
                                        </form>
                                    ...
                                    <div className="pt-6 flex items-center space-x-4">
                                        <button className="bg-blue-500 flex justify-center items-center w-96 text-white px-6 py-3 rounded-md shadow-md hover:bg-blue-600 transition-colors">
                                            Submit
                                        </button>
