            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                {images.map((image, index) => (
                    ...
                    >
                        ...
                        />
                        <div className="absolute inset-0 bg-black bg-opacity-50 opacity-100 flex items-center justify-center transition-opacity duration-300">
