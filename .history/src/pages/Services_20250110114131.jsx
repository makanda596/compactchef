...
const Services = () => {
    ...
    // Set default service title when category changes
    useEffect(() => {
        if (filteredServices.length > 0) {
            setSelectedServiceTitle(filteredServices[0].title);
        } else {
                    ...
                    {filteredServices.map((service) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-2 right-2">
                                ...
                                {menuOpen === service.id && (
                                    <div className="absolute bg-white shadow-md rounded-lg mt-[-150px] right-0 w-40">
                                        <button
                    ...
                    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
                        <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                {/* Dropdown for selecting service title */}
                                <div className="mb-4">
                                    <label className="block text-sm font-medium text-gray-700">Select Service Title</label>
                                    <select
                                        name="serviceTitle"
