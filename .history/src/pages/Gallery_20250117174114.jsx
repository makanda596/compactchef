            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
                    <div className="relative">
                        <button
                            onClick={closeModal}
                            className="absolute top-4 right-8 text-white text-2xl bg-black rounded-full p-2 hover:bg-opacity-80"
                        >
                            &times;
                        </button>
                        <img
                        ...
                        <div className="absolute bg-gold bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-4">
                            <IconButton
                                onClick={zoomIn}
