                            ...
                            <div className="absolute bottom-2 right-2">
                                ...
                                {menuOpen === service.id && (
                                    <div className="absolute bottom-12 right-0  shadow-lg rounded-lg px-4  text-gray-800 z-10">
                                        <button
                                            className="block bg-blue-600 px-0 py-1 text-left text-white hover:bg-green-600 w-full border-b-2 "
                                        ...
                                        <button
                                            className="block px-4 py-1 bg-gold text-left hover:bg-gray-100 w-full"
                                        >
