    ...
    return (
        <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center w-full sm:py-12">
            <div className="relative py-3 sm:max-w-full sm:mx-auto">
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-0">
                        ...
                        <div className="w-full sm:w-1/2 p-4">
                            <div className="divide-y divide-gray-200">
                                ...
                                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div className="flex flex-col">
                                        <label className="leading-loose">Type of Service</label>
                                        <select
                                            className="px-4 py-2 border focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                        >
                                    ...
                                    <div className="flex flex-col">
                                        <label className="leading-loose">Number of People</label>
                                        <input
                                            type="number"
                                            className="px-4 py-2 border focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    ...
                                    <div className="flex flex-col">
                                        <label className="leading-loose">Venue (If Already Decided)</label>
                                        <input
                                            type="text"
                                            className="px-4 py-2 border focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                    ...
                                    <div className="flex flex-col">
                                        <label className="leading-loose">Company Name (Optional)</label>
                                        <input
                                            type="text"
                                            className="px-4 py-2 border focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
