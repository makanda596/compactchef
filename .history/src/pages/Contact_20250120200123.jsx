                            ...
                            <div className="pb-6">
                                ...
                                <div className="space-y-4">
                                    <p className="flex items-center">
                                        ...
                                        <span className=" hover:text-blue-600">Kisumu, Kenya</span>
                                    </p>
                                    <p className="flex items-center">
                                        <PhoneIcon className="mr-3 text-2xl" />
                                        <a href="tel:+254791317298" target="_blank" rel="noopener noreferrer " className=" hover:text-blue-600">
                                            +254 791 317 298
                                        </a>
                                    </p>
                                    <p className="flex items-center">
                                        <EmailIcon className="mr-3 text-2xl" />
                                        <a href="mailto:compactchefsevents@gmail.com" className=" hover:text-blue-600 font-serif text-base" target="_blank" rel="noopener noreferrer">
