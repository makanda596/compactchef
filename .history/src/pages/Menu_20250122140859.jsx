...
function Menu() {
    ...
    useEffect(() => {
        alert(
            "Welcome to our personalized menu experience! Let us craft a menu that perfectly suits your tastes and preferences, ensuring a delightful and customized experience for you.");
    }, []);

    return (
        <div className="bg-gray-100 py-12">
            <div className="max-w-7xl mx-auto px-6">
                <h2 className="text-2xl font-extrabold text-center text-gray-800 mb-8">Our Menu</h2>
