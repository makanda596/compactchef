                            ...
                            <div className="absolute bottom-2 right-2">
                                ...
                                {menuOpen === service.id && (
                                    <div className="absolute bottom-12 right-0 bg-white shadow-lg rounded-lg p-2 text-gray-800 z-10">
                                        <button
                                            className="block px-2 py-2 text-left hover:bg-gold w-full border-b-2 "
                                            onClick={() => alert(`Book menu for ${service.title}`)}
                                        >
                                            Book Now
                                        </button>

                                        <button
                                            className="block px-4 py-2 text-start hover:bg-gray-100 w-full"
