                ...
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white p-8 rounded-lg w-96">
                        ...
                        <p className="text-sm mb-4">
                            ...
                            "Feel free to explore our services, and when you find the one that best suits your needs, simply click the 'Book Now' button to submit a quick booking form. Our team will be happy to assist you!"   </p>
