                                    ...
                                    <form onSubmit={onSubmit}>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <input type="text" name="num_people" className="px-4 py-3 w-full border-2 border-gray-300 rounded-md shadow-md focus:ring-2 focus:ring-indigo-500 transition-colors" placeholder="Number of People" />
                                            </div>
                                            <div className="flex flex-col">
