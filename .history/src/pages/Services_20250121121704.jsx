...
const Services = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-50 pt-100 pb-10">
            {/* Sidebar */}
            <aside
            ...
            <main className="flex-1 p-8 overflow-y-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    {filteredServices.map((service) => (
                        <div
                            key={service.id}
                            className="relative p-4 bg-white rounded-lg shadow hover:shadow-xl"
                        >
                            <img
                                src={service.image}
                                alt={service.title}
            ...
            {showModal && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
                    <div className="bg-white p-8 rounded-lg w-96">
                        ...
                        <button
                            className="block w-full text-center bg-gray-700 text-white py-2 rounded-lg hover:bg-gray-600"
