                    ...
                    {filteredServices.map((service) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-2 right-2">
                                ...
                                {menuOpen === service.id && (
                                    <div className="absolute bottom-12 right-0 bg-white shadow-lg rounded- px-4  text-gray-800 z-10">
                                        <button
                                            className="block bg-blue-600 px-0 py-2 ml-2 text-left hover:bg-green-600 w-full border-b-2 "
                                        ...
                                        <button
                                            className="block px-4 py-2 bg-gold text-left hover:bg-gray-100 w-full"
                                        >
                                            <a href='/contact' className="px-[-2px]">Contact </a>
                                        </button>
                                    </div>
                                )}
                            </div>
