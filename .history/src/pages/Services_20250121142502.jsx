        ...
        <div className="flex h-screen bg-gray-50 pt-20 pb-10">
            ...
            {showPopup && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-start z-50">
                    <div className="bg-white p-4 rounded-lg w-72 md:w-96">
                        ...
                        <div className="flex justify-end">
                            <button
                                className="bg-gray-600 text-white px-4 py-2 flex justify-center items-centre rounded-md"
                    ...
                    <div className="bg-white p-8 rounded-lg w-96">
                        ...
                        <form ef={formRef} onSubmit={onSubmit}>
                            ...
                            <div className="mb-4">
                                ...
                                <input type="date" name="date" required="true" className="w-full p-2 border border-gray-300 rounded-md" />
                            </div>
            ...
            {submitted && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white rounded-lg p-6 text-center shadow-lg z-50">
                        <h2 className="text-2xl font-bold text-gray-800 mb-4">Booking Submitted!</h2>
