...
const services = [
    {
        ...
        document: "https://via.placeholder.com/150", // Replace with actual document URL
    },
    {
        id: 2,
                    ...
                    {filteredServices.map((service) => (
                        ...
                        >
                            ...
                            <a
                                ...
                                download
                                className="mt-4 block text-center bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-700"
                            >
                                Download Document
                            </a>
                        </div>
