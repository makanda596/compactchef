            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                {images.map((image, index) => (
                    ...
                    >
                        ...
                        />
                        <div className="absolute flex justify-center text-centre inset-0 bg-black bg-opacity-30  flex items-center justify-center transition-opacity duration-300">
                            <span className="text-white  text-base">{image.eventPlace}</span>
                        </div>
                        <button
