...
const ContactPage = () => {
    return (
        <div>
            <div className="min-h-screen bg-gray-100 py-6 px-2 mt-6 w-full sm:py-12 flex-col-reverse ">
                <div className="relative py-3 sm:max-w-full sm:mx-auto sm:flex-col-reverse ">
