...
const Services = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-50 pt-20 pb-10">
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 h-96 bg-gray-800 text-white w-64 p-6 transform ${isSidebarOpen ? "translate-x-0 " : "-translate-x-full"
                    } transition-transform duration-300 md:relative md:h-full md:translate-x-0 overflow-y-auto z-10`}
            >
