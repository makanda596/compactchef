...
const ContactPage = () => {
    return (
        <div className="h-96 bg-gray-100 py-6 flex flex-col justify-center w-full sm:py-12">
            <div className="relative py-3 sm:max-w-full sm:mx-auto">
                <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-0">
                    <div className="flex flex-wrap w-full">
                        ...
                        <div className="w-full sm:w-1/2 p-6 bg-gradient-to-b from-blue-500 to-purple-600 text-white rounded-xl shadow-lg">
                            <div className="pb-6">
