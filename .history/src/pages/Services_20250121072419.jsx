                    ...
                    {filteredServices.map((service) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-2 right-2">
                                ...
                                {menuOpen === service.id && (
                                    <div className="absolute bottom-12 right-0 bg-white shadow-lg rounded-lg p-4 text-gray-800 z-10">
                                        <button
                                        ...
                                        <button
                                            className="block px-2 py-2 text-left hover:bg-gray-100 w-full"
                                        >
