        ...
        <div className="bg-white py-8">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <form onSubmit={handleSubmit} className="mb-6 p-4 bg-gray-100 rounded-lg shadow md:w-1/2">
                    ...
                    <input type="text" name="name" placeholder="Your Name / Company (optional)" value={name} onChange={(e) => setName(e.target.value)}  className="w-full p-2 mb-2 border rounded" />
